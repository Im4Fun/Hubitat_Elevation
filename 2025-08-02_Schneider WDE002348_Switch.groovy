 ...
 *  Provides on/off, toggle, refresh, and configuration commands.
...
def toggle() {
    if (logEnable) log.debug "Sending TOGGLE command"
    zigbee.command(0x0006, 0x02) // On/Off cluster, toggle command
}
